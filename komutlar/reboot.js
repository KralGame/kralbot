...
message.channel.sendMessage(' ```Botun yeniden başlatılmasına onay veriyorsanız 30 saniye içinde veriyom veriyom tamam yazın.``` ')
.then(() => {
  message.channel.awaitMessages(response => response.content === "veriyom veriyom tamam", {
    max: 1,
    time: 30000,
    errors: ['time'],
  })
